...
; Title:
;
;   PD07 -- PIC "4-pin" 10^7 frequency divider (10 MHz to 1 Hz)
;
; Function:
;
;   This PIC program implements a digital frequency divider: the external
;   input clock is divided by a factor of 10 million (1e7). For example,
;   if the input clock is 10 MHz then the output clock will be 1 Hz.
;
; Diagram:
;                                ---__---
...
; A 1,250,000 instruction (400 ns each) loop takes exactly 0.5 seconds.
