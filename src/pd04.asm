...
; Title:
;
;   PD04 -- PIC "4-pin" 10^4 frequency divider (10 MHz to 1 kHz)
;
; Function:
;
;   This PIC program implements a digital frequency divider: the external
;   input clock is divided by a factor of 10 thousand (1e4). For example,
;   if the input clock is 10 MHz then the output clock will be 1 kHz.
;
; Diagram:
;                                ---__---
...
; Output pins are toggled once per loop creating a 1 kHz square wave.
